...
public class MakeMyVoiceHeardWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence widgetText1 = "Representative: Van Jones";
        ...
        CharSequence widgetText2 = "Senator: Cruz";
        views.setTextViewText(R.id.widget_senator1, widgetText1);

        CharSequence widgetText3 = "Representative: Cornyn";
        views.setTextViewText(R.id.widget_senator2, widgetText1);
